...
const tokenModule = sdk.getTokenModule(
  "0x4234ccAB25631174227815Ad78A024d2F7DB0EAB"
);

const voteModule = sdk.getVoteModule(
  "0x3509EA13A31525407fBDbAf919BF39e53AD0Ceb7"
);
...
const App = () => {
    ...
    return (
      <div>
        <div className="connected-address">
          <div className="card">{shortenAddress(address)}</div>
        </div>
        <div className="member-page">
          <h1>PotatoDAO Member Page</h1>
  ...
  return (
    <div className="mint-nft">
      <h1>Mint your free PotatoDAO Membership NFT</h1>
